...
<header class="app-header"><a class="app-header__logo" style="font-family: 'Cairo', 'sans-serif';"
                              href="{{ route('admin.home') }}">{{ setting('title') }}</a>
    ...
    <ul class="app-nav">
        ...
        {{--theme switcher--}}
        <button class="btn btn-light btn-sm" id="switch-theme" style="margin-top: 10px; margin-bottom: 10px;">Switch
            Theme
        </button>
        ...
        <li class="dropdown" id="notifications">
            ...
            <ul class="app-notification dropdown-menu dropdown-menu-right">
                ...
                <li class="app-notification__footer"><a
                        href="#">@lang('site.all') @lang('notifications.notifications')</a></li>
            </ul>
        </li>
